...
@pytest.mark.parametrize(
    ...
    [
        pytest.param({"type": "default"}, {"step": 6}, [0, 6, 12], [6], id="inst"),
        pytest.param(
            {"type": "default"}, {"step": "0-6"}, [0, 3, 6, 12], [3, 6], id="range"
        ),
        pytest.param(
            {"type": "default", "include_start": True},
            {"step": "0-6"},
            [0, 3, 6, 12],
            [0, 3, 6],
            id="range-with-start",
        ...
        pytest.param(
            {"type": "default", "include_start": True, "allow_missing_zero": True},
            {"step": "0-6"},
            [0, 3, 6, 12],
            [0, 3, 6],
        ...
        pytest.param(
            {"type": "deaccumulate", "allow_missing_zero": True},
            {"step": "0-6"},
            [6, 9, 12],
            [6],
        ...
        pytest.param(
            {"type": "deaccumulate", "by": 24, "allow_missing_zero": True},
            {"step": "0-12"},
            [12, 18, 24],
            [24],
            id="deacc-range-by",
        ...
        pytest.param(
            {"type": "monthly", "include_start": True},
            {"fcmonth": 1, "date": "20250601"},
            list(range(0, 745, 6)),
            list(range(0, 721, 6)),
        ...
        pytest.param(
            {"type": "select", "index": 0, "include_start": True},
            {"step": "0-24"},
            [0, 12, 24],
            [0],
