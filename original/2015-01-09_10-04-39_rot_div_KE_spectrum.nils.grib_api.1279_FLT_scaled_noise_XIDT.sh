...
\rm -f targx1
cat >dir<< EOF
retrieve,class=rd,expver=$EXP,levtype=ml,type=fc,source="/fwsm/lb/user/naw/ifs_t399_noise.gw_diag/ICMSHfyt4+000004",
   date=$DATE,time=$TIME,step=1,
   level=$LEV,param=D/VO,target="targx1"
EOF
mars dir
#cp /fwsm/lb/user/naw/ifs_t399_noise.gw_diag/ICMSHfyt4+000000 targx1
#cp /fwsm/lb/user/naw/ifs_t399_noise.gw_diag/ICMSHfyt4+000001 targx1
#cp /fwsm/lb/user/naw/ifs_t399_noise.gw_diag/ICMSHfyt4+000002 targx1
